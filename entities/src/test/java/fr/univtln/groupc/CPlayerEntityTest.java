...
public class CPlayerEntityTest extends TestCase {
    ...
    public void testGetResonatorById() throws Exception {
        ...
        AObjectEntity lReso2 = new CResonatorEntity.CResonatorBuilder().name("myPortal2").level(3).build();
        AObjectEntity lReso3 = new CResonatorEntity.CResonatorBuilder().name("myPortal3").level(3).build();
        AObjectEntity lReso4 = new CResonatorEntity.CResonatorBuilder().name("myPortal4").level(4).build();
        AObjectEntity lKey1 = new CKeyEntity.CKeyBuilder().name("myKey").build();
        lObjects.add(lReso1);
        lObjects.add(lReso2);
        lObjects.add(lReso3);
        lObjects.add(lReso4);
    ...
    public void testGetTurretById() throws Exception {
        ...
        AObjectEntity lReso4 = new CResonatorEntity.CResonatorBuilder().name("myPortal4").level(4).build();
        AObjectEntity lKey1 = new CKeyEntity.CKeyBuilder().name("myKey").build();
        AObjectEntity lTurret1 = new CTurretEntity.CTurretBuilder().name("myTurret1").level(3).build();
        AObjectEntity lTurret2 = new CTurretEntity.CTurretBuilder().name("myTurret2").level(3).build();
        AObjectEntity lTurret3 = new CTurretEntity.CTurretBuilder().name("myTurret3").level(3).build();
        AObjectEntity lTurret4 = new CTurretEntity.CTurretBuilder().name("myTurret4").level(4).build();
