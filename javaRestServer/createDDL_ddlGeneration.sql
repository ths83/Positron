...
ALTER TABLE positron.t_stats_building_attacked ADD CONSTRAINT FK_t_stats_building_attacked_building_fk FOREIGN KEY (building_fk) REFERENCES positron.t_object (id)
