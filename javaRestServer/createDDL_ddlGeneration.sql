...
CREATE TABLE positron.t_portal (portal_id INTEGER NOT NULL, latitude FLOAT, longitude FLOAT, radius INTEGER, portal INTEGER, PRIMARY KEY (portal_id))
...
ALTER TABLE positron.t_object ADD CONSTRAINT FK_t_object_portal_fk FOREIGN KEY (portal_fk) REFERENCES positron.t_portal (portal_id)
ALTER TABLE positron.t_building ADD CONSTRAINT FK_t_building_id FOREIGN KEY (id) REFERENCES positron.t_object (id)
ALTER TABLE positron.t_portal ADD CONSTRAINT FK_t_portal_portal FOREIGN KEY (portal) REFERENCES positron.t_team (id)
