...
CREATE TABLE positron.t_stats_building_attacked (MID INTEGER NOT NULL, MBUILDING_id INTEGER, MRESONATOR_id INTEGER, PRIMARY KEY (MID))
...
CREATE TABLE t_portal_t_resonator (CPortalEntity_portal_id INTEGER NOT NULL, mResonators_id INTEGER NOT NULL, PRIMARY KEY (CPortalEntity_portal_id, mResonators_id))
...
ALTER TABLE positron.t_stats_building_attacked ADD CONSTRAINT FK_t_stats_building_attacked_MBUILDING_id FOREIGN KEY (MBUILDING_id) REFERENCES positron.t_object (id)
...
ALTER TABLE t_portal_t_resonator ADD CONSTRAINT FK_t_portal_t_resonator_CPortalEntity_portal_id FOREIGN KEY (CPortalEntity_portal_id) REFERENCES positron.t_portal (portal_id)
ALTER TABLE t_portal_t_resonator ADD CONSTRAINT FK_t_portal_t_resonator_mResonators_id FOREIGN KEY (mResonators_id) REFERENCES positron.t_object (id)
...
ALTER TABLE positron.t_team_t_player ADD CONSTRAINT FK_t_team_t_player_CTeamEntity_id FOREIGN KEY (CTeamEntity_id) REFERENCES positron.t_team (id)
...
ALTER TABLE positron.t_team_t_portal ADD CONSTRAINT FK_t_team_t_portal_CTeamEntity_id FOREIGN KEY (CTeamEntity_id) REFERENCES positron.t_team (id)
