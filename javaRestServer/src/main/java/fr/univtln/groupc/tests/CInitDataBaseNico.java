...
public class CInitDataBaseNico {
    ...
    public static void main(String[] args) {
        ...
        // resonators
        AObjectEntity lReso1 = new CResonatorEntity.CResonatorBuilder().energyMax(100).level(4).energy(100).build();
        AObjectEntity lReso2 = new CResonatorEntity.CResonatorBuilder().energyMax(100).energy(100).level(3).build();
        AObjectEntity lReso3 = new CResonatorEntity.CResonatorBuilder().energyMax(100).energy(100).level(5).build();
        AObjectEntity lReso4 = new CResonatorEntity.CResonatorBuilder().energyMax(100).energy(100).level(3).build();
        AObjectEntity lReso5 = new CResonatorEntity.CResonatorBuilder().energy(100).energyMax(100).level(2).build();

        // keys
        AObjectEntity lKey6 = new CKeyEntity.CKeyBuilder().portal(lPortalId6).build();
        AObjectEntity lKey8 = new CKeyEntity.CKeyBuilder().portal(lPortalId8).build();

        // attack
        AObjectEntity lAttack1 = new CConsumableEntity.CConsumableBuilder().name("Attack").rarity(1).build();
        AObjectEntity lAttack2 = new CConsumableEntity.CConsumableBuilder().name("Attack").rarity(2).build();
        ...
        AObjectEntity lKeyPortal8 = new CKeyEntity.CKeyBuilder().portal(lPortalId8).build();
        AObjectEntity lKeyPortal28 = new CKeyEntity.CKeyBuilder().portal(lPortalId8).build();
        AObjectEntity lKeyPortal27 = new CKeyEntity.CKeyBuilder().portal(lPortalId7).build();
        AObjectEntity lKeyPortal30 = new CKeyEntity.CKeyBuilder().portal(lPortalId10).build();
        AObjectEntity lKeyPortal31 = new CKeyEntity.CKeyBuilder().portal(lPortalId11).build();
        AObjectEntity lKeyPortal32 = new CKeyEntity.CKeyBuilder().portal(lPortalId12).build();
        AObjectEntity lKeyPortal33 = new CKeyEntity.CKeyBuilder().portal(lPortalId13).build();
        AObjectEntity lKeyPortal34 = new CKeyEntity.CKeyBuilder().portal(lPortalId14).build();
        AObjectEntity lKeyPortal35 = new CKeyEntity.CKeyBuilder().portal(lPortalId15).build();
        AObjectEntity lKeyPortal42 = new CKeyEntity.CKeyBuilder().portal(lPortalId12).build();
/*
